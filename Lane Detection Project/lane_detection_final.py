...
Original file is located at
    https://colab.research.google.com/drive/1rFVorVUhJ0HaE6JqPG9zObKqHMHUx9IC
"""
...
def draw_lane_polygon(image, line1, line2,present,frames):
  ...
  max_base = max(abs(x1 - x2), abs(x3-x4))  # the bottom base width in pixels
  ...
  add_text_to_image(base_text,lane_image, position=(430,150))   #FOR DEBUGING PURPOSES 
...
def main():
  ...
  # Below VideoWriter object will create video 
  ...
  prev_l = None   #left line from previous frame
  prev_r = None   #right line from prrevious frame 
  frames = 0   
  while(cap.isOpened()):
      ret, frame = cap.read()
